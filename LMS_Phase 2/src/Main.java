...
public class Main {
    ...
    If the book is already checked in or the title doesn't match, an error message will occur
     */
    public static void Check_In() {
        ...
        try {
            ...
            if(changeStatus){
                ...
                pw.println(id + "," + title + "," + author + "," + genre + "," + status + ",Due Date:" + returnDate);
                System.out.println();
    ...
    This method uses the overloaded Remove() method to remove the old status and due date, and then writes the updated information to the text file
    If the book is already checked out or the title doesn't match, an error message will occur
     */
    public static void Check_Out() {
        ...
        try {
            ...
            if(changeStatus){
                ...
                pw.println(id + "," + title + "," + author + "," + genre + "," + status + ",Due Date:" + returnDate);
                System.out.println();
                System.out.println(title + " is due by: " + returnDate);
    ...
    /*
    The overloaded Remove() method is responsible for removing the old book status when checking in or checking out a book
    It takes a book title as a parameter and doesn't return any value
     */
